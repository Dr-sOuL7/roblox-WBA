--[=[
	...
	There is NO ring-out: the walls contain the Bey (see PhysicsController).

	Stamina slows spin decay; structural balance (profile.balance) speeds tilt
	recovery. Sets the match-level finish flags TickManager/MatchInstance consume.
]=]
